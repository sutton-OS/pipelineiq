...
export declare const JOB_TYPES: readonly ["lead_created", "inbound_received", "follow_up", "reminder", "send_outbound"];
export type JobType = (typeof JOB_TYPES)[number];
export type ConversationState = "awaiting_yes" | "awaiting_time_choice" | "booked" | "needs_staff_attention" | "closed";
...
export type JobPayload = JobPayloadLeadCreated | JobPayloadInboundReceived | JobPayloadFollowUp | JobPayloadReminder | JobPayloadSendOutbound;
